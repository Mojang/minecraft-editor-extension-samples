...
import { Vector3Utils, VECTOR3_UP, VECTOR3_ZERO } from '@minecraft/math';
...
class PreviewVolume {
    ...
    constructor(uiSession: IPlayerUISession) {
        ...
        this._widget = this._widgetGroup.createWidget(VECTOR3_ZERO, { visible: false, selectable: false });
